...
- (instancetype)initWithCategoryPage:(NTYTSettingsCategoryPage)categoryPage {
    ...
    if (self) {
        ...
        self.title = NTYTCategoryTitle(categoryPage);
    }
    return self;
}
...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self.tableView registerClass:UITableViewCell.class forCellReuseIdentifier:@"NTYTCategoryCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"NTYTCategoryCell"
    ...
    if (indexPath.row == 0) {
        cell.textLabel.text = NTYTListTitle(listID);
    ...
    cell.textLabel.text = NTYTOptionTitle(optionID);
